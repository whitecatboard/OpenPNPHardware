...
dist/${CND_CONF}/${IMAGE_TYPE}/Feeder.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    ../Bootloader.X/dist/default/production/Bootloader.X.production.hex
	...
	@"C:/Program Files (x86)/Microchip/MPLABX/v5.20/mplab_platform/platform/../mplab_ide/modules/../../bin/hexmate" --edf="C:/Program Files (x86)/Microchip/MPLABX/v5.20/mplab_platform/platform/../mplab_ide/modules/../../dat/en_msgs.txt" dist/${CND_CONF}/${IMAGE_TYPE}/Feeder.X.${IMAGE_TYPE}.hex ../Bootloader.X/dist/default/production/Bootloader.X.production.hex -odist/${CND_CONF}/production/Feeder.X.production.unified.hex
